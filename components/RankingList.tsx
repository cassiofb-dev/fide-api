      ...
      <div className="flex-1 overflow-y-auto min-h-[400px]">
        ...
        {listLoading ? (
          <div className="p-4 space-y-3">
            <div className="flex flex-col items-center justify-center py-6 text-center border-b border-border/30 mb-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
              ...
              <span className="text-xs text-muted-foreground font-semibold">
                Trying to get rankings from FIDE (Attempt {attempt}/4)...
              </span>
            </div>
